...
@media(min-width:600px){body.app-in .sidebar{display:flex!important;position:relative!important;inset:auto!important;width:218px!important;height:auto!important;flex-basis:218px!important;transform:none!important;pointer-events:auto!important;visibility:visible!important}.topbar,.dock{display:none!important}body.app-in .wrap{max-width:1180px!important}.bento{grid-template-columns:repeat(4,minmax(0,1fr))!important}.b-wide{grid-column:span 2!important}}
...
@media(max-width:599px){.ref-greeting{font-size:24px!important}.ref-rhythm-card{border-radius:25px!important}.ref-rhythm-copy{padding:20px!important}.ref-rhythm-stats{display:grid!important;grid-template-columns:repeat(3,1fr)!important;gap:10px!important}.ref-rhythm-stats b{font-size:26px!important}.ref-main-grid{grid-template-columns:1fr!important}.dock{padding:10px 7px!important}.dock-item span{font-size:9px!important}}
`;
...
function wireDrawer(){
 ...
 document.querySelectorAll('.sidebar .nav-item').forEach(b=>b.addEventListener('click',()=>{if(innerWidth<600)close()}));
}
